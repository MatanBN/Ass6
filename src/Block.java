...
public class Block implements Collidable, Sprite {
    ...
    /**
     * drawOn method draws the block and the block's number of hits on a given surface.
    ...
    public void drawOn (DrawSurface d){
        ...
        d.drawText(this.rectangle.getX() + this.rectangle.getWidth() / 2, this.rectangle.getY() +
                this.rectangle.getHeight() / 2, s, 10);
    }
