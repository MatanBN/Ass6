...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        game.addCollidable(new Block(0,300, 1, 300));
        game.addCollidable(new Block(400,300, 400, 1));

        game.addCollidable(new Block(130, 10, 30, 10));
        game.addCollidable(new Block(160, 10, 30, 10));
